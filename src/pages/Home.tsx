                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm">
                                ...
                                <li className="flex items-center gap-3"><Send className="w-5 h-5 text-blue-500 shrink-0" /><a href="mailto:mike@demandio.cloud" className="hover:text-white transition">mike@demandio.cloud</a></li>
                            </ul>
                        </div>
                        <div>
